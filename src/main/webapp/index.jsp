               ...
               <div class="col-md-6 col-sm-6">
                    <div class="home-thumb">
                         <div class="section-title">
                              <h4 class="wow fadeInUp" data-wow-delay="0.3s">hello welcome to my website</h4>
               ...
               <div class="bg-yellow col-md-3 col-sm-6">
                    <div class="skill-thumb">
                         <div class="wow fadeInUp section-title color-white" data-wow-delay="1.2s">
                              <h1>My Skills</h1>
                              <p class="color-white">CICD Pipeline, Docker, Web Design, Python</p>
                         </div>

                         <div class=" wow fadeInUp skills-thumb" data-wow-delay="1.6s">
                         <strong>Designing 3-tier Architecture</strong>
                              <span class="color-white pull-right">90%</span>
                                   <div class="progress">
                                        <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div>
                                   </div>

                         <strong>Contineus Delivery</strong>
               ...
               <div class="bg-yellow col-md-3 col-sm-6">
                    <div class="wow fadeInUp color-white service-thumb" data-wow-delay="0.8s">
                         <i class="fa fa-desktop"></i>
                              <h3><font color=black>Technologies</font></h3>
                              <p class="color-white">I am good at Amazon Web Services(AWS), Worked on linux, Windows based systems.experience in creating highly available 3-tier architecture model</p>
                    </div>
               </div>
               ...
               <div class="col-md-3 col-sm-6">
                    <div class="wow fadeInUp color-white service-thumb" data-wow-delay="1.2s">
                         <i class="fa fa-paper-plane"></i>
                              <h3><font color=black>Tools Known</font></h3>
                              <p class="color-white">Git, github, Jenkins, Maven, Ansible, Slack, Html,css</p>
                    </div>
               </div>
               ...
               <div class="bg-dark col-md-3 col-sm-6">
                    <div class="wow fadeInUp color-white service-thumb" data-wow-delay="1.6s">
                         <i class="fa fa-table"></i>
                              <h3><font color=white>About DevOps</font></h3>
                              <p class="color-white">“To successfully implement continuous delivery, you need to change the culture of how an entire organization views software development efforts.”</p>
                    </div>
               </div>
               ...
               <div class="bg-white col-md-3 col-sm-6">
                    <div class="wow fadeInUp service-thumb" data-wow-delay="1.8s">
                         <i class="fa fa-html5"></i>
                              <h3><font color=black>Other Tools</font></h3>
                              <p class="color-black">SonarQube, Sonatype-Nexus, Docker, Kubernetes, Prometheus, Grafana, Python, Shell scripting, Vpc, 							  </p>
                    </div>
               </div>
                    ...
                    <div class="color-white experience-thumb">
                         ...
                         <div class="wow fadeInUp color-white media" data-wow-delay="1.2s">
                              ...
                              <div class="media-body">
                                   <h3 class="media-heading">Solution Architect <small>2018 Jul - 2018 Nov</small></h3>
                                   <p class="color-white">Worked on cloud (AWS)</p>
                              </div>
                         </div>
                         ...
                         <div class="wow fadeInUp color-white media" data-wow-delay="1.6s">
                              ...
                              <div class="media-body">
                                   <h3 class="media-heading">DevOps Engineer <small>2018 Dec - Present</small></h3>
                                   <p class="color-white">Experience in continuous integration as well as continuous delivery and deployment.</p>
                              </div>
                         </div>
                    ...
                    <div class="color-white education-thumb">
                         ...
                         <div class="wow fadeInUp color-white media" data-wow-delay="1.6s">
                              ...
                              <div class="media-body">
                                   ...
                                   <p class="color-white">6 months of real Industrial training in cloud computing </p>
                              </div>
                         </div>
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    ...
                    <h2 class="wow fadeInUp" data-wow-delay="0.8s">“The most powerful tool we have as DevOps engineer is automation.”</h2>
                    <p class="wow fadeInUp" data-wow-delay="1s">“Simply put, things always had to be in a production-ready state: if you wrote it, you darn well had to be there to get it running!”</p>
               </div>
               ...
               <div class="col-md-6 col-sm-12">
                    <div class="contact-form">
                         <div class="wow fadeInUp section-title" data-wow-delay="0.2s">
                              ...
                              <p class="color-white">Please feel free to contact me if you need any further information. Please let me know if you have any questions.</p>
                         </div>
               ...
               <div class="bg-dark col-md-3 col-sm-6">
                    <div class="contact-thumb">
                         ...
                         <div class="wow fadeInUp contact-info" data-wow-delay="0.8s">
                              ...
                              <p><i class="fa fa-envelope-o"></i> <a href="mailto:hello@andromedafuture.tech">hello@andromedafuture.tech</a></p>
                              <p><i class="fa fa-globe"></i> <a href="#">andromedafuture.tech</a></p>
                         </div>
